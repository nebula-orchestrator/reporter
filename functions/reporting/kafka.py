...
def kafka_consume(bootstrap_servers, security_protocol="PLAINTEXT", sasl_mechanism=None, sasl_plain_username=None,
    ...
    consumer = KafkaConsumer(topic, group_id=group_id, security_protocol=security_protocol,
